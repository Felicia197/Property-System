<%-- 
    Document   : purchased_customer
    Created on : Aug 11, 2023, 2:26:52 PM
    Author     : Felicia
--%>
...
<html>
    <head>
        ...
        <title>Customer Purchased Properties Page</title>
        <style>
            body {
    ...
    <body>
        <header>
            <h1>View & Rate Purchased Properties</h1>
        </header>
        <nav>
        ...
        <main>
            <form action="CustomerPurchased" method="POST">
                <table>
                    ...
                    <tr>
                        <td><label for="sell_rate">Rating (1-5):</label></td>
                        <td><input type="number" id="sell_rate" name="sell_rate" min="1" max="5" size="30"></td>
                    </tr>
                    <tr>
                        <td><label for="sell_comment">Comment:</label></td>
                        <td><input type="text" id="sell_comment" name="sell_comment" size="30"></td>
                    </tr>
                </table>
                <table>
                    <tr>
                        <td>      
                            ...
                            <input type="submit" name="action" value="Show All Purchased Properties" />  

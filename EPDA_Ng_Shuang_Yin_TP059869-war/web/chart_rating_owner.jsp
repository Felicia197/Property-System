<%-- 
    Document   : chart_rating_owner
    Created on : Aug 13, 2023, 12:37:03 AM
    Author     : Felicia
--%>
...
<body>
    ...
    <main>
        <h2>Ratings By Owners</h2>
        <div class="chart-container">
            <canvas id="ratingOwnerChart" width="600" height="400"></canvas>
        </div>
        ...
        <script>
            ...
            var ctx = document.getElementById('ratingOwnerChart').getContext('2d');
            var ratingOwnerChart = new Chart(ctx, {
                type: 'bar',
                data: {
                    labels: ['Rating 1', 'Rating 2', 'Rating 3', 'Rating 4', 'Rating 5'],
                    datasets: [{
                        label: 'Ratings By Owners',

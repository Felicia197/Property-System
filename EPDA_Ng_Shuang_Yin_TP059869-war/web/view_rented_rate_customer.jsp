<%-- 
    Document   : bookedproperties_customer
    Created on : Aug 11, 2023, 1:55:24 PM
    Author     : Felicia
--%>
...
<html>
    <head>
        ...
        <title>Customer Rented Propertes Page</title>
        <style>
            body {
    ...
    <body>
        <header>
            <h1>View & Rate Rented Properties</h1>
        </header>
        <nav>
        ...
        <main>
            <form action="CustomerBooked" method="POST">
                <table>
                    ...
                    <tr>
                        <td><label for="rent_rate">Rating (1-5):</label></td>
                        <td><input type="number" id="rent_rate" name="rent_rate" min="1" max="5" size="30"></td>
                    </tr>
                    <tr>
                        <td><label for="rent_comment">Comment:</label></td>
                        <td><input type="text" id="rent_comment" name="rent_comment" size="30"></td>
                    </tr>
                </table>
                <table>
                    <tr>
                        <td>      
                            ...
                            <input type="submit" name="action" value="Show All Rented Properties" />  

<%-- 
    Document   : chart_gender_owner
    Created on : Aug 12, 2023, 11:11:18 PM
    Author     : Felicia
--%>
...
<head>
    ...
    <title>Owner Gender Distribution</title>
    <style>
        body {
...
<body>
    <header>
        <h1>Owner Gender Distribution</h1>
    ...
    <main>
        <h2>Owner Gender Distribution</h2>

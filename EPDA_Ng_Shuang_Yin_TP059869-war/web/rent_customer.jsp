<%-- 
    Document   : rent_customer
    Created on : Aug 10, 2023, 2:37:44 PM
    Author     : Felicia
--%>
...
<html>
    <head>
        ...
        <title>Customer Rent Properties Page</title>
        <style>
            body {
        ...
        <main>
            <form action="CustomerRent" method="POST">
                ...
                <table>
                    <tr>
                        <td>      
                            <input type="submit" name="action" value="Book Rent Property" />

<%-- 
    Document   : chart_total_sales
    Created on : Aug 12, 2023, 11:40:47 PM
    Author     : Felicia
--%>
...
<body>
    ...
    <main>
        <h2>Total Sales (Rented Properties & Sold Properties)</h2>
        <div class="chart-container">
            <canvas id="totalSalesChart" width="400" height="400"></canvas>
        </div>
        <script>
            var totalrentedSales = ${totalrentedSales};
            var totalsoldSales = ${totalsoldSales};

            console.log("totalrentedSales", totalrentedSales);
            console.log("totalsoldSales", totalsoldSales);
            ...
            var rentpropertyChart = new Chart(ctx, {
                ...
                data: {
                    labels: ['Rented Properties Sales', 'Sold Properties Sales'],
                    datasets: [{
                        label: 'Total Sales (Rented Properties & Sold Properties)',
                        data: [totalrentedSales, totalsoldSales],

<%-- 
    Document   : chart_rating_customer
    Created on : Aug 13, 2023, 12:22:41 AM
    Author     : Felicia
--%>
...
<head>
    ...
    <title>Ratings By Customers</title>
    <style>
        body {
...
<body>
    ...
    <main>
        <h2>Ratings By Customers</h2>
        <div class="chart-container">
            <canvas id="ratingCustomerChart" width="600" height="400"></canvas>
        </div>
        ...
        <script>
            ...
            var ctx = document.getElementById('ratingCustomerChart').getContext('2d');
            var ratingCustomerChart = new Chart(ctx, {
                type: 'bar',
                data: {
                    labels: ['Rating 1', 'Rating 2', 'Rating 3', 'Rating 4', 'Rating 5'],
                    datasets: [{
                        label: 'Ratings By Customers',

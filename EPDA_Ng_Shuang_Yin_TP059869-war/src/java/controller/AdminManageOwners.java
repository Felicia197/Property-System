 ...
 * @author Felicia
 */
@WebServlet(name = "AdminManageOwners", urlPatterns = {"/AdminManageOwners"})
public class AdminManageOwners extends HttpServlet {
            ...
            try {
                ...
                if (action != null){
                    ...
                    // Search 
                        ...
                        request.getRequestDispatcher("admin_manage_owner.jsp").forward(request, response);
                    }
                ...
                request.getRequestDispatcher("admin_manage_owner.jsp").include(request, response);
            }
        }

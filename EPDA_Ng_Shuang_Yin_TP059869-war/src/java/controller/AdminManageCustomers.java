 ...
 * @author Felicia
 */
@WebServlet(name = "AdminManageCustomers", urlPatterns = {"/AdminManageCustomers"})
public class AdminManageCustomers extends HttpServlet {
            ...
            try {
                ...
                if (action != null){
                    ...
                    // Search                  
                        ...
                        request.getRequestDispatcher("admin_manage_customer.jsp").forward(request, response);
                    }
                    ...
                    // Show All Data
                        ...
                        // Show Table
                        // Retrieve the list of customers from the CustomerFacade
                ...
                // If there is error, will go back to the jsp page
                request.setAttribute("errorMessage", "Wrong input!");
                request.getRequestDispatcher("admin_manage_customer.jsp").include(request, response);
            }
    ...
    private List<Customer> searchCustomers(String searchQuery) {
        ...
        // Retrieve the list of customers from data source
